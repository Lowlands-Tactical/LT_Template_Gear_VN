/*
	...
	File: LT_camo_US_Navy_Olive.sqf
	Tijdperk: VN
	Author: R.Hoods
	
	Description: Standaard US Navy Gear, kleur olive.
...
_unif = ["vn_b_uniform_macv_01_07","vn_b_uniform_macv_02_07","vn_b_uniform_macv_03_07","vn_b_uniform_macv_04_07","vn_b_uniform_macv_05_07","vn_b_uniform_macv_06_07"];
_vest = ["vn_b_vest_usarmy_11","vn_b_vest_usarmy_12","vn_b_vest_usarmy_13","vn_b_vest_usarmy_14"];
_helm = ["vn_b_helmet_m1_01_01","vn_b_bandana_01","vn_b_bandana_04"];
// Optioneel medic kleding
_unifMedic = [""];
_vestMedic = ["vn_b_vest_usarmy_13"];
_helmMedic = ["vn_b_helmet_m1_01_01"];
